...
int virtual_chain_p3()
{
  ...
  std::shared_ptr<chain::ChainSyncManager> virtualChain = std::shared_ptr<chain::ChainSyncManager>( new chain::ChainSyncManager( *latestBlockItr, nullptr ,toRequesterSBC ) );
  ...
  requestHeaderVector.push_back( block_0002->header() );
