...
public:
  VirtualBlockSyncManager( std::vector<std::shared_ptr<BlockHeader>> virtualHeaderChainVector/* これを元にvirtual_block_chainを作成する */ , std::shared_ptr<BlockLocalStrageManager> localStrageManager , std::shared_ptr<StreamBufferContainer> toRequesterSBC );
