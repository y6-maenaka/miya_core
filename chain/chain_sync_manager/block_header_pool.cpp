...
std::pair< bool, short > VirtualHeaderSyncManager::BlockHeaderPool::push( std::shared_ptr<BlockHeader> target )
{
...
std::shared_ptr<BlockHeader> VirtualHeaderSyncManager::BlockHeaderPool::findByBlockHash( std::shared_ptr<unsigned char> blockHash )
{
...
std::vector< std::shared_ptr<BlockHeader> > VirtualHeaderSyncManager::BlockHeaderPool::findByPrevBlockHash( std::shared_ptr<unsigned char> prevBlockHash )
{
  std::vector< std::shared_ptr<BlockHeader> >  retVector;
